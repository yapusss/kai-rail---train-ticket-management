...
const TrainServicesScreen: React.FC<TrainServicesScreenProps> = ({ setActiveTab, setSelectedServiceType, setBookingFormData }) => {
    ...
    //                     <div></div>
    //                 </div>
    //                 <p className="text-sm opacity-90 mt-2 ml-10">{service.description}</p>
    //             </div>
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
            ...
            <div className="bg-gradient-to-br from-purple-600 to-blue-600 text-white p-4 rounded-b-3xl">
                ...
                <p className="text-sm opacity-90 mt-2 ml-10">Pilih jenis layanan kereta yang Anda butuhkan</p>
            </div>
