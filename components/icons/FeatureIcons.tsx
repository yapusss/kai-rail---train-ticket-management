...
export const FoodIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M13 17h8m-8-4h8m-8-4h8M3 21h18M3 17h.01M3 13h.01M3 9h.01M3 5h.01M5 5h14a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2z" />
  </svg>
);
...
export const AttendantIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a2 2 0 01-2-2V7a2 2 0 012-2h6M5 8h2a2 2 0 002-2V4a2 2 0 00-2-2H5z" />
    </svg>
);

export const SparklesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m1-12a1 1 0 011 1v2a1 1 0 01-2 0V6a1 1 0 011-1zm5 4a1 1 0 011 1v2a1 1 0 01-2 0V9a1 1 0 011-1zm5-4a1 1 0 011 1v2a1 1 0 01-2 0V6a1 1 0 011-1zm-5 4a1 1 0 011 1v2a1 1 0 01-2 0V9a1 1 0 011-1zM9 13a1 1 0 011 1v2a1 1 0 01-2 0v-2a1 1 0 011-1zm5-4a1 1 0 011 1v2a1 1 0 01-2 0V9a1 1 0 011-1z" />
  </svg>
);
...
export const RebookIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h5M20 12a8 8 0 10-2.34 5.67" />
  </svg>
);
...
export const InterCityTrainIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 12h16M4 12l2-2m-2 2l2 2M20 12l-2-2m2 2l-2 2M8 8h8a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2v-4a2 2 0 012-2zM7 16v2M17 16v2M9 6v2M15 6v2" />
  </svg>
);
